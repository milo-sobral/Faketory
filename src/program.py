...
def get_final_score (spell, rel_score, bias_score, URL_recognizer_score) :
...
def calc() :
    url = 'https://www.bbc.com/news/world-europe-46233560'
    file_to_evaluate = get_json_file(url)
    # spell = get_spell_checker_score(file_to_evaluate)
    bias_score, rel_score = get_scores(file_to_evaluate)
